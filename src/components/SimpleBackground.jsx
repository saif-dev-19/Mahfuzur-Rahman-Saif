    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <div
          ...
          style={{
            backgroundImage: `
              ...
              radial-gradient(1px 1px at 80% 60%, #8b5cf6, transparent),
              radial-gradient(1px 1px at 60% 80%, #3b82f6, transparent)
            `,
      ...
      <div className="absolute inset-0">
        {particles.map((p, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 rounded-full opacity-50 will-change-transform"
            style={{
              left: p.left,
              top: p.top,
              backgroundColor:
